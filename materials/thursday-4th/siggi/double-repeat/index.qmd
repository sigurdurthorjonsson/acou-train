...
author: 
  ...
  - Teresa da Silva
footer: "[🔗 https://heima.hafro.is/~sigurdur/acou-train/](https://heima.hafro.is/~sigurdur/acou-train/materials/thursday-4th/siggi/double-repeat) / SÞJ Thursday"
...
## Results --- Aðalsteinn Jónsson

```{r}
#| label: fig-alli-perbars
#| fig-cap: "'Perbars' of capelin NASC in 0.1 sjm intervals in second coverage, Aðalsteinn Jónsson, 28--31 January."
#| out-width: "150%" 
...
ssb <- matrix(c(first,ammassak,alli,second),ncol=4,
  dimnames=list(NULL,c("First coverage","Ammassak","Aðalsteinn","Second coverage both vessels")))
...
```{r}
#| label: tbl-boot
#| tbl-cap: "Descriptive statistics of bootstrap-replicates for first coverage, the coverages of Polar Ammassak and Aðalsteinn Jónsson, and second coverage both vessels together. SSB, 5%-tile and median in thous. tonnes, CV bootstrap coefficient of variation." 
